...
export async function writeDraft({ storeId, brief, type = 'collection', platform, brandVoice, metafieldDefinitions, placement }: { storeId: string; brief: any; type?: string; platform?: string; brandVoice?: any; metafieldDefinitions?: any[]; placement?: any }) {
...
Return structured content. For metafields use exact "namespace.key" keys. Body and chosen metas must not duplicate content.`;
