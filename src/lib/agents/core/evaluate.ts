...
export async function evaluate(draft: any, type = 'collection', platform?: string, brandVoice?: any, metafieldDefinitions?: any[], placement?: any, products: any[] = [], brief?: any, research?: any) {
  // Delegate to the rich grader (score 0-10). Scale to 0-1 for legacy callers.
  const g = await gradeDraft({ draft, type, platform, brandVoice, metafieldDefinitions, placement, products, brief, research });
